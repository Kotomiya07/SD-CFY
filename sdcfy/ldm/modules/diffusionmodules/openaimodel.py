...
from sdcfy.ldm.util import exists
import sdcfy.ops
...
class Upsample(nn.Module):
    ...
    def __init__(self, channels, use_conv, dims=2, out_channels=None, padding=1, dtype=None, device=None, operations=sdcfy.ops):
        super().__init__()
