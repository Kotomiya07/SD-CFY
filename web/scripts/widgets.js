...
function addMultilineWidget(node, name, opts, app) {
	...
	inputEl.className = "sdcfy-multiline-input";
...
function isSlider(display, app) {
	if (app.ui.settings.getSettingValue("sdcfy.DisableSliders")) {
		return "number"
	}
...
export const sdcfyWidgets = {
	"INT:seed": seedWidget,
	"INT:noise_seed": seedWidget,
	FLOAT(node, inputName, inputData, app) {
		let widgetType = isSlider(inputData[1]["display"], app);
		let precision = app.ui.settings.getSettingValue("sdcfy.FloatRoundingPrecision");
		let disable_rounding = app.ui.settings.getSettingValue("sdcfy.DisableFloatRounding")
