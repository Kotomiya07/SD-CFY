	...
	"light": {
		...
		"colors": {
			...
			"sdcfy_base": {
				"fg-color": "#222",
				"bg-color": "#DDD",
				"sdcfy-menu-bg": "#F5F5F5",
				"sdcfy-input-bg": "#C9C9C9",
				"input-text": "#222",
				"descrip-text": "#444",
				"drag-text": "#555",
				"error-text": "#F44336",
	...
	"solarized": {
		...
		"colors": {
			...
			"sdcfy_base": {
				...
				"sdcfy-menu-bg": "#073642", // Base02
				"sdcfy-input-bg": "#002b36", // Base03
	...
	"arc": {
		...
		"colors": {
			...
			"sdcfy_base": {
			  "fg-color": "#fff",
			  "bg-color": "#2b2f38",
			  "sdcfy-menu-bg": "#242730",
			  "sdcfy-input-bg": "#2b2f38",
			  "input-text": "#ddd",
			  "descrip-text": "#b2b7bd",
			  "drag-text": "#ccc",
			  "error-text": "#ff4444",
	...
	"nord": {
		...
		"colors": {
			...
			"sdcfy_base": {
			  "fg-color": "#e5eaf0",
			  "bg-color": "#2e3440",
			  "sdcfy-menu-bg": "#161b22",
			  "sdcfy-input-bg": "#2e3440",
			  "input-text": "#bcc2c8",
			  "descrip-text": "#999",
			  "drag-text": "#ccc",
			  "error-text": "#ff4444",
	...
	"github": {
		...
		"colors": {
			...
			"sdcfy_base": {
			  "fg-color": "#e5eaf0",
			  "bg-color": "#161b22",
			  "sdcfy-menu-bg": "#13171d",
			  "sdcfy-input-bg": "#161b22",
			  "input-text": "#bcc2c8",
			  "descrip-text": "#999",
			  "drag-text": "#ccc",
			  "error-text": "#ff4444",
...
const id = "sdcfy.ColorPalette";
const idCustomColorPalettes = "sdcfy.CustomColorPalettes";
...
app.registerExtension({
	...
	addCustomNodeDefs(node_defs) {
		...
		const getColorPaletteTemplate = async () => {
			...
			for (const key in defaultColorPalette.colors.sdcfy_base) {
				if (!colorPalette.colors.sdcfy_base[key]) {
					colorPalette.colors.sdcfy_base[key] = "";
				}
			}
		...
		const loadColorPalette = async (colorPalette) => {
			...
			if (colorPalette.colors) {
				...
				if (colorPalette.colors.sdcfy_base) {
					const rootStyle = document.documentElement.style;
					for (const key in colorPalette.colors.sdcfy_base) {
						rootStyle.setProperty('--' + key, colorPalette.colors.sdcfy_base[key]);
					}
				}
