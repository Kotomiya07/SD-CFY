...
const id = "sdcfy.NodeTemplates";
const file = "sdcfy.templates.json";

class ManageTemplates extends sdcfyDialog {
	constructor() {
		super();
		this.load().then((v) => {
			this.templates = v;
						...
						$el(
							"div",
							{
								...
								style: {
									...
									gap: "5px",
									backgroundColor: "var(--sdcfy-menu-bg)"
								},
								ondragstart: (e) => {
										...
										$el("input", {
											...
											onchange: (e) => {
												...
												this.saveVisualCue = setTimeout(function () {
													...
													el.style.backgroundColor = 'var(--sdcfy-input-bg)';
												}, 15);
											},
											onkeypress: (e) => {
												var el = e.target;
