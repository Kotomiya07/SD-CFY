...
class SaveLatent:
    ...
    def INPUT_TYPES(s):
        return {"required": { "samples": ("LATENT", ),
                              "filename_prefix": ("STRING", {"default": "latents/sdcfy"})},
    ...
    def save(self, samples, filename_prefix="sdcfy", prompt=None, extra_pnginfo=None):
...
class SaveImage:
    ...
    def INPUT_TYPES(s):
        return {"required": 
                    {"images": ("IMAGE", ),
                     "filename_prefix": ("STRING", {"default": "sdcfy"})},
                "hidden": {"prompt": "PROMPT", "extra_pnginfo": "EXTRA_PNGINFO"},
                }
    ...
    def save_images(self, images, filename_prefix="sdcfy", prompt=None, extra_pnginfo=None):
